...
namespace MeerPflege.Persistence.Migrations
{
    ...
    [Migration("20230601160737_workingHoursAddForeignKey")]
    partial class workingHoursAddForeignKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeerPflege.Domain.ActivityElderPresence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ActivityElderPresences");
                });
            ...
            modelBuilder.Entity("MeerPflege.Domain.Elder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeerPflege.Domain.WallItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeerPflege.Domain.WallItemAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WallItemId");

                    b.ToTable("WallItemAttachments");
                });

            modelBuilder.Entity("MeerPflege.Domain.WorkingHoursForDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkingHoursForDays");
                });

            modelBuilder.Entity("MeerPflege.Domain.WorkingInterval", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WorkingHoursForDayId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WorkingHoursForDayId");
            ...
            modelBuilder.Entity("MeerPflege.Domain.ActivityElderPresence", b =>
                {
                    b.HasOne("MeerPflege.Domain.Activity", "Activity")
                        .WithMany()
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MeerPflege.Domain.Elder", "Elder")
                        .WithMany()
            ...
            modelBuilder.Entity("MeerPflege.Domain.Elder", b =>
                {
                    b.HasOne("MeerPflege.Domain.Carer", "Carer")
                        .WithMany()
            ...
            modelBuilder.Entity("MeerPflege.Domain.WallItemAttachment", b =>
                {
                    b.HasOne("MeerPflege.Domain.WallItem", "WallItem")
                        .WithMany("WallItemAttachments")
                        .HasForeignKey("WallItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WallItem");
                });
            ...
            modelBuilder.Entity("MeerPflege.Domain.WorkingInterval", b =>
                {
                    b.HasOne("MeerPflege.Domain.WorkingHoursForDay", "WorkingHoursForDay")
                        .WithMany()
                        .HasForeignKey("WorkingHoursForDayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WorkingHoursForDay");
                });
            ...
            modelBuilder.Entity("MeerPflege.Domain.WallItem", b =>
                {
                    b.Navigation("WallItemAttachments");
                });
